  ...
  en: {
    ...
    privacy: {
      ...
      sections: [
        ...
        { h: "2. Information we collect", body: "<p>Drag & Shot: Basketball Arcade collects only the minimum necessary information.</p><ul><li><strong>On-device storage:</strong> Stage progress, star ratings and game settings are stored locally on your device and are never sent to our servers.</li><li><strong>Advertising data:</strong> The App uses the Google AdMob advertising service. To serve and measure ads, information such as your advertising identifier, IP address, device information and app usage may be collected and processed by Google and its advertising partners.</li><li><strong>Inquiry info (optional):</strong> Email address and message content when contacting support.</li></ul>" },
